"use strict";
(self["webpackChunkmy_project"] = self["webpackChunkmy_project"] || []).push([[6651],{
...
const package_namespaceObject = {"rE":"4.13.7"};
...
const FieldWrapper = (0,styled_components_browser_esm/* default */.Ay)((0,Field/* Field */.D))`
  height: ${32 / 16}rem;
  width: ${32 / 16}rem;
...
const NpsSurvey = () => {
  ...
  const { npsSurveySettings, setNpsSurveySettings } = (0,useNpsSurveySettings/* useNpsSurveySettings */.W)();
  ...
  const { currentEnvironment, strapiVersion } = (0,helper_plugin_esm/* useAppInfo */.Xe)();
  ...
  const handleSubmitResponse = ({ npsSurveyRating: rating, npsSurveyFeedback: comment }) => {
    const { email } = helper_plugin_esm/* auth */.j2.getUserInfo();
    mutate({
      email,
      rating,
      comment,
  ...
  return /* @__PURE__ */ react.createElement(Portal/* Portal */.Z, null, /* @__PURE__ */ react.createElement(
    formik_esm/* Formik */.l1,
    {
      initialValues: { npsSurveyFeedback: "", npsSurveyRating: null },
      onSubmit: handleSubmitResponse,
      validationSchema: yup_es/* object */.Ik({
        npsSurveyFeedback: yup_es/* string */.Yj(),
        npsSurveyRating: yup_es/* number */.ai().required()
      })
    },
    ({ values, handleChange, setFieldValue }) => /* @__PURE__ */ react.createElement(formik_esm/* Form */.lV, { name: "npsSurveyForm" }, /* @__PURE__ */ react.createElement(
      Flex/* Flex */.s,
      {
        hasRadius: true,
        direction: "column",
      ...
      isFeedbackResponse ? /* @__PURE__ */ react.createElement(Typography/* Typography */.o, { fontWeight: "semiBold" }, formatMessage({
        id: "app.components.NpsSurvey.feedback-response",
        defaultMessage: "Thank you very much for your feedback!"
      })) : /* @__PURE__ */ react.createElement(Box/* Box */.a, { as: "fieldset", width: "100%" }, /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { justifyContent: "space-between", width: "100%" }, /* @__PURE__ */ react.createElement(Box/* Box */.a, { marginLeft: "auto", marginRight: "auto" }, /* @__PURE__ */ react.createElement(Typography/* Typography */.o, { fontWeight: "semiBold", as: "legend" }, formatMessage({
      ...
      )), /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { gap: 2, marginTop: 2, marginBottom: 2, justifyContent: "center" }, /* @__PURE__ */ react.createElement(Typography/* Typography */.o, { variant: "pi", textColor: "neutral600" }, formatMessage({
        ...
        return /* @__PURE__ */ react.createElement(
          ...
          /* @__PURE__ */ react.createElement(FieldLabel/* FieldLabel */.d, { htmlFor: `nps-survey-rating-${number}-input` }, /* @__PURE__ */ react.createElement(VisuallyHidden/* VisuallyHidden */.s, null, /* @__PURE__ */ react.createElement(
      ...
      }))), values.npsSurveyRating !== null && /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { direction: "column" }, /* @__PURE__ */ react.createElement(Box/* Box */.a, { marginTop: 2 }, /* @__PURE__ */ react.createElement(FieldLabel/* FieldLabel */.d, { htmlFor: "npsSurveyFeedback", fontWeight: "semiBold", fontSize: 2 }, formatMessage({
        id: "app.components.NpsSurvey.feedback-question",
        defaultMessage: "Do you have any suggestion for improvements?"
      }))), /* @__PURE__ */ react.createElement(Box/* Box */.a, { width: "62%", marginTop: 3, marginBottom: 4 }, /* @__PURE__ */ react.createElement(
        Textarea/* Textarea */.T,
        {
      ...
      )), /* @__PURE__ */ react.createElement(Button/* Button */.$, { marginBottom: 2, type: "submit", loading: isLoading }, formatMessage({
...
var at = __webpack_require__(47031);
...
const LeftMenu = ({ generalSectionLinks, pluginsSectionLinks }) => {
  ...
  return /* @__PURE__ */ react.createElement(MainNav/* MainNav */.N, { condensed }, /* @__PURE__ */ react.createElement(
    ...
    }))), /* @__PURE__ */ react.createElement(LinkUser, { tabIndex: 0, onClick: handleLogout, to: "/auth/login" }, /* @__PURE__ */ react.createElement(Typography/* Typography */.o, { textColor: "danger600" }, formatMessage({
...
const CM = (0,react.lazy)(
  () => Promise.all(/* import() | content-manager */[__webpack_require__.e(8832), __webpack_require__.e(252), __webpack_require__.e(8772), __webpack_require__.e(4492)]).then(__webpack_require__.bind(__webpack_require__, 75321))
);
const HomePage = (0,react.lazy)(() => __webpack_require__.e(/* import() | Admin_homePage */ 7675).then(__webpack_require__.bind(__webpack_require__, 71807)));
const InstalledPluginsPage = (0,react.lazy)(
  () => __webpack_require__.e(/* import() | Admin_pluginsPage */ 2076).then(__webpack_require__.bind(__webpack_require__, 13572))
);
const MarketplacePage = (0,react.lazy)(
  () => __webpack_require__.e(/* import() | Admin_marketplace */ 9140).then(__webpack_require__.bind(__webpack_require__, 87007))
);
...
const SettingsPage = (0,react.lazy)(
  () => __webpack_require__.e(/* import() | Admin_settingsPage */ 4981).then(__webpack_require__.bind(__webpack_require__, 44823)).then((module) => ({
...
/* harmony import */ var _strapi_design_system__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(17715);
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(96540);
/* harmony import */ var _strapi_design_system__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6803);
/* harmony import */ var _strapi_design_system__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(46699);
/* harmony import */ var _strapi_design_system__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(17937);
/* harmony import */ var _strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(39150);
/* harmony import */ var _strapi_icons__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(95844);
