"use strict";
(self["webpackChunkmy_project"] = self["webpackChunkmy_project"] || []).push([[4981],{
...
const ROUTES_CE = [
  ...
  {
    async Component() {
      const component = await Promise.all(/* import() | admin-edit-roles-page */[__webpack_require__.e(38), __webpack_require__.e(6823)]).then(__webpack_require__.bind(__webpack_require__, 12370));
      return component;
    },
  ...
  {
    async Component() {
      const component = await Promise.all(/* import() | admin-edit-roles-page */[__webpack_require__.e(38), __webpack_require__.e(6823)]).then(__webpack_require__.bind(__webpack_require__, 49659));
      return component;
    },
  ...
  {
    async Component() {
      const component = await __webpack_require__.e(/* import() | webhook-list-page */ 4001).then(__webpack_require__.bind(__webpack_require__, 95272));
      return component;
    },
  ...
  {
    async Component() {
      const component = await Promise.all(/* import() | api-tokens-create-page */[__webpack_require__.e(38), __webpack_require__.e(5723), __webpack_require__.e(8727), __webpack_require__.e(2415)]).then(__webpack_require__.bind(__webpack_require__, 48441));
      return component;
    },
  ...
  {
    async Component() {
      const component = await Promise.all(/* import() | api-tokens-edit-page */[__webpack_require__.e(38), __webpack_require__.e(5723), __webpack_require__.e(8727), __webpack_require__.e(6723)]).then(__webpack_require__.bind(__webpack_require__, 83321));
      return component;
    },
  ...
  {
    async Component() {
      const component = await Promise.all(/* import() | transfer-tokens-create-page */[__webpack_require__.e(38), __webpack_require__.e(5723), __webpack_require__.e(6364), __webpack_require__.e(9962)]).then(__webpack_require__.bind(__webpack_require__, 51040));
      return component;
    },
  ...
  {
    async Component() {
      const component = await Promise.all(/* import() | transfer-tokens-edit-page */[__webpack_require__.e(38), __webpack_require__.e(5723), __webpack_require__.e(6364), __webpack_require__.e(3170)]).then(__webpack_require__.bind(__webpack_require__, 50788));
      return component;
    },
...
var ExternalLink = __webpack_require__(28325);
...
var CarouselInput = __webpack_require__(24495);
// EXTERNAL MODULE: ./node_modules/@strapi/design-system/dist/CarouselInput/CarouselActions.mjs
var CarouselActions = __webpack_require__(45998);
...
var CarouselSlide = __webpack_require__(92336);
...
var PicturePlus = __webpack_require__(11658);
...
const ApplicationInfosPage = () => {
      ...
      select(data2) {
        return {
          ...
          authLogo: data2.authLogo ? {
            ...data2.authLogo,
            url: (0,helper_plugin_esm/* prefixFileUrlWithBackendUrl */.vX)(data2.authLogo.url)
          } : data2.authLogo,
          menuLogo: data2.menuLogo ? {
            ...data2.menuLogo,
            url: (0,helper_plugin_esm/* prefixFileUrlWithBackendUrl */.vX)(data2.menuLogo.url)
          } : data2.menuLogo
        };
      }
    }
  ...
  return /* @__PURE__ */ react.createElement(Layout/* Layout */.P, null, /* @__PURE__ */ react.createElement(helper_plugin_esm/* SettingsPageTitle */.x7, { name: "Application" }), /* @__PURE__ */ react.createElement(Main/* Main */.g, null, isLoading ? /* @__PURE__ */ react.createElement(Loader/* Loader */.a, null, formatMessage({
    ...
    HeaderLayout/* HeaderLayout */.Q,
    {
      ...
      primaryAction: canUpdate && /* @__PURE__ */ react.createElement(Button/* Button */.$, { type: "submit", startIcon: /* @__PURE__ */ react.createElement(Check/* default */.A, null) }, formatMessage({ id: "global.save", defaultMessage: "Save" }))
    }
...
function SettingsPage() {
  ...
  const adminRoutes = react.useMemo(() => {
    return (0,makeUniqueRoutes/* default */.A)(
      routes.map(({ to, Component, exact }) => (0,createRoute/* default */.A)(Component, to, exact))
    );
  }, [routes]);
  const pluginsRoutes = Object.values(settings).flatMap((section) => {
    const { links } = section;
    return links.map((link) => (0,createRoute/* default */.A)(link.Component, link.to, link.exact || false));
  });
  if (isLoading) {
  ...
  return /* @__PURE__ */ react.createElement(Layout/* Layout */.P, { sideNav: /* @__PURE__ */ react.createElement(components_SettingsNav, { menu }) }, /* @__PURE__ */ react.createElement(
    Helmet/* Helmet */.m,
    {
      title: formatMessage({
        id: "global.settings",
  ...
  ), /* @__PURE__ */ react.createElement(react_router/* Switch */.dO, null, /* @__PURE__ */ react.createElement(react_router/* Route */.qh, { path: "/settings/application-infos", component: pages_ApplicationInfosPage, exact: true }), adminRoutes, pluginsRoutes));
}
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   C: () => (/* binding */ SubNav)
/* harmony export */ });
/* unused harmony export subNavWidth */
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(74848);
/* harmony import */ var styled_components__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(40948);
/* harmony import */ var _Grid_Grid_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(99525);




const subNavWidth = `${232 / 16}rem`;
const SubNavWrapper = (0,styled_components__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Ay)((0,_Grid_Grid_mjs__WEBPACK_IMPORTED_MODULE_2__/* .Grid */ .x)) `
  width: ${subNavWidth};
...
var keyboardKeys = __webpack_require__(74475);
...
var SearchForm = __webpack_require__(91626);
...
const CustomDivider = (0,styled_components_browser_esm/* default */.Ay)((0,Divider/* Divider */.c)) `
  width: ${24 / 16}rem;
...
const SubNavHeader = ({ as = 'h2', label, searchLabel = '', searchable = false, onChange = () => { }, value = '', onClear = () => { }, onSubmit = () => { }, id, }) => {
    ...
    const clearButtonId = (0,useId/* useId */.B)(id);
    ...
    const handleKeyDown = (e) => {
        if (e.key === keyboardKeys/* KeyboardKeys */.K.ESCAPE) {
            setSearchOpen(false);
        }
    };
    if (isSearchOpen) {
        return ((0,jsx_runtime.jsxs)(Box/* Box */.a, { paddingLeft: 4, paddingTop: 5, paddingBottom: 2, paddingRight: 4, children: [(0,jsx_runtime.jsx)(SearchForm/* SearchForm */.B, { children: (0,jsx_runtime.jsx)(Searchbar/* Searchbar */.S, { name: "searchbar", value: value, onChange: onChange, placeholder: "e.g: strapi-plugin-abcd", onKeyDown: handleKeyDown, ref: searchRef, onBlur: handleBlur, onClear: handleClear, onSubmit: onSubmit, clearLabel: "Clear", size: "S", children: searchLabel }) }), (0,jsx_runtime.jsx)(Box/* Box */.a, { paddingLeft: 2, paddingTop: 4, children: (0,jsx_runtime.jsx)(CustomDivider, {}) })] }));
    }
    return ((0,jsx_runtime.jsxs)(Box/* Box */.a, { paddingLeft: 6, paddingTop: 6, paddingBottom: 2, paddingRight: 4, children: [(0,jsx_runtime.jsxs)(Flex/* Flex */.s, { justifyContent: "space-between", alignItems: "flex-start", children: [(0,jsx_runtime.jsx)(Typography/* Typography */.o, { variant: "beta", as: as, children: label }), searchable && ((0,jsx_runtime.jsx)(IconButton/* IconButton */.K, { ref: searchButtonRef, onClick: toggleSearch, label: searchLabel, icon: (0,jsx_runtime.jsx)(Search/* default */.A, {}) }))] }), (0,jsx_runtime.jsx)(Box/* Box */.a, { paddingTop: 4, children: (0,jsx_runtime.jsx)(CustomDivider, {}) })] }));
};
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   u: () => (/* binding */ SubNavLink)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(74848);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(96540);
/* harmony import */ var _strapi_icons__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(43841);
/* harmony import */ var styled_components__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(40948);
/* harmony import */ var _Box_Box_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(17715);
/* harmony import */ var _Typography_Typography_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(17937);
/* harmony import */ var _Flex_Flex_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(6803);
/* harmony import */ var _BaseLink_BaseLink_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(83055);
...
const SubNavLinkWrapper = (0,styled_components__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Ay)((0,_Box_Box_mjs__WEBPACK_IMPORTED_MODULE_3__/* .Box */ .a)) `
  display: flex;
  align-items: center;
  ...
  &.active {
    ...
    return `
      ...
      ${_Typography_Typography_mjs__WEBPACK_IMPORTED_MODULE_4__/* .Typography */ .o} {
...
`;
const CustomBullet = (0,styled_components__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Ay)((0,_strapi_icons__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .A)) `
  width: ${12 / 16}rem;
  height: ${4 / 16}rem;
  * {
...
`;
const IconWrapper = styled_components__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Ay.div `
  svg {
    height: ${12 / 16}rem;
    width: ${12 / 16}rem;
  }
`;
const SubNavLink = react__WEBPACK_IMPORTED_MODULE_1__.forwardRef(({ children, icon = null, withBullet = false, as = _BaseLink_BaseLink_mjs__WEBPACK_IMPORTED_MODULE_6__/* .BaseLink */ .s, isSubSectionChild = false, ...props }, ref) => {
    return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(SubNavLinkWrapper, { as: as, icon: icon, background: "neutral100", paddingLeft: isSubSectionChild ? 9 : 7, paddingBottom: 2, paddingTop: 2, ref: ref, ...props, children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_Flex_Flex_mjs__WEBPACK_IMPORTED_MODULE_7__/* .Flex */ .s, { children: [icon ? (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(IconWrapper, { children: icon }) : (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(CustomBullet, {}), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_Box_Box_mjs__WEBPACK_IMPORTED_MODULE_3__/* .Box */ .a, { paddingLeft: 2, children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_Typography_Typography_mjs__WEBPACK_IMPORTED_MODULE_4__/* .Typography */ .o, { as: "span", children: children }) })] }), withBullet && ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_Box_Box_mjs__WEBPACK_IMPORTED_MODULE_3__/* .Box */ .a, { as: _Flex_Flex_mjs__WEBPACK_IMPORTED_MODULE_7__/* .Flex */ .s, paddingRight: 4, children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(CustomBullet, { "$active": true }) }))] }));
});
...
const SubNavSectionLabelWrapper = (0,styled_components_browser_esm/* default */.Ay)((0,Flex/* Flex */.s)) `
  border: none;
  padding: 0;
...
const SubNavSectionLabel = ({ collapsable = false, label, onClick = () => { }, ariaExpanded, ariaControls, }) => {
    if (collapsable) {
        return ((0,jsx_runtime.jsxs)(SubNavSectionLabelWrapper, { as: "button", onClick: onClick, "aria-expanded": ariaExpanded, "aria-controls": ariaControls, textAlign: "left", children: [(0,jsx_runtime.jsx)(Box/* Box */.a, { paddingRight: 1, children: (0,jsx_runtime.jsx)(Typography/* Typography */.o, { variant: "sigma", textColor: "neutral600", children: label }) }), collapsable && ((0,jsx_runtime.jsx)(DropDownIconWrapper, { rotated: ariaExpanded, children: (0,jsx_runtime.jsx)(CarretDown/* default */.A, { "aria-hidden": true }) }))] }));
    }
    return ((0,jsx_runtime.jsx)(SubNavSectionLabelWrapper, { children: (0,jsx_runtime.jsx)(Box/* Box */.a, { paddingRight: 1, children: (0,jsx_runtime.jsx)(Typography/* Typography */.o, { variant: "sigma", textColor: "neutral600", children: label }) }) }));
};
...
const SubNavSectionWrapper = (0,styled_components_browser_esm/* default */.Ay)((0,Box/* Box */.a)) `
  svg {
    height: ${4 / 16}rem;
    path {
...
const SubNavSection = ({ collapsable = false, label, badgeLabel, children, id }) => {
    ...
    return ((0,jsx_runtime.jsxs)(Flex/* Flex */.s, { direction: "column", alignItems: "stretch", gap: 1, children: [(0,jsx_runtime.jsx)(SubNavSectionWrapper, { paddingLeft: 6, paddingTop: 2, paddingBottom: 2, paddingRight: 4, children: (0,jsx_runtime.jsxs)(Box/* Box */.a, { position: "relative", paddingRight: badgeLabel ? 6 : 0, children: [(0,jsx_runtime.jsx)(SubNavSectionLabel, { onClick: handleClick, ariaExpanded: isOpen, ariaControls: listId, collapsable: collapsable, label: label }), badgeLabel && ((0,jsx_runtime.jsx)(Badge/* Badge */.E, { backgroundColor: "neutral150", textColor: "neutral600", position: "absolute", right: 0, top: "50%", transform: "translateY(-50%)", children: badgeLabel }))] }) }), (!collapsable || isOpen) && ((0,jsx_runtime.jsx)("ol", { id: listId, children: react.Children.map(children, (child, index) => {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   w: () => (/* binding */ SubNavSections)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(74848);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(96540);
/* harmony import */ var _Box_Box_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(17715);
...
const SubNavSections = ({ children, spacing = 2, horizontal = false, ...props }) => {
    return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_Box_Box_mjs__WEBPACK_IMPORTED_MODULE_2__/* .Box */ .a, { paddingTop: 2, paddingBottom: 4, children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_Flex_Flex_mjs__WEBPACK_IMPORTED_MODULE_3__/* .Flex */ .s, { as: "ol", gap: spacing, direction: horizontal ? 'row' : 'column', alignItems: horizontal ? 'center' : 'stretch', ...props, children: react__WEBPACK_IMPORTED_MODULE_1__.Children.map(children, (child, index) => {
