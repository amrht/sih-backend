"use strict";
(self["webpackChunkmy_project"] = self["webpackChunkmy_project"] || []).push([[4001],{
...
const Switch = react.forwardRef(({ label, onChange, onLabel = 'On', offLabel = 'Off', selected, visibleLabels = false, ...props }, ref) => {
    return ((0,jsx_runtime.jsx)(SwitchButton, { ref: ref, role: "switch", "aria-checked": selected, "aria-label": label, onClick: onChange, visibleLabels: visibleLabels, type: "button", ...props, children: (0,jsx_runtime.jsxs)(Flex/* Flex */.s, { children: [(0,jsx_runtime.jsxs)(SwitchContent, { children: [(0,jsx_runtime.jsx)("span", { children: onLabel }), (0,jsx_runtime.jsx)("span", { children: offLabel })] }), visibleLabels && ((0,jsx_runtime.jsx)(Box/* Box */.a, { as: "span", "aria-hidden": true, paddingLeft: 2, color: selected ? 'success600' : 'danger600', children: selected ? onLabel : offLabel }))] }) }));
});
