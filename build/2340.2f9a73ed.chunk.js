(self["webpackChunkmy_project"] = self["webpackChunkmy_project"] || []).push([[2340],{
...
function setTimeZoneInOptions(opts, timeZone) {
    return Object.keys(opts).reduce(function (all, k) {
        all[k] = (0,tslib_es6/* __assign */.Cl)({ timeZone: timeZone }, opts[k]);
        return all;
    }, {});
}
function deepMergeOptions(opts1, opts2) {
    var keys = Object.keys((0,tslib_es6/* __assign */.Cl)((0,tslib_es6/* __assign */.Cl)({}, opts1), opts2));
    return keys.reduce(function (all, k) {
        all[k] = (0,tslib_es6/* __assign */.Cl)((0,tslib_es6/* __assign */.Cl)({}, (opts1[k] || {})), (opts2[k] || {}));
        return all;
    }, {});
}
...
var formatMessage = function (_a, state, messageDescriptor, values, opts) {
    ...
    (0,lib_utils/* invariant */.V1)(!!msgId, "[@formatjs/intl] An `id` must be provided to format a message. You can either:\n1. Configure your build toolchain with [babel-plugin-formatjs](https://formatjs.io/docs/tooling/babel-plugin)\nor [@formatjs/ts-transformer](https://formatjs.io/docs/tooling/ts-transformer) OR\n2. Configure your `eslint` config to include [eslint-plugin-formatjs](https://formatjs.io/docs/tooling/linter#enforce-id)\nto autofix this issue");
    var id = String(msgId);
    var message = 
    ...
    if (Array.isArray(message) &&
        message.length === 1 &&
        message[0].type === lib/* TYPE */.ZE.literal) {
    ...
    values = (0,tslib_es6/* __assign */.Cl)((0,tslib_es6/* __assign */.Cl)({}, defaultRichTextElements), (values || {}));
    ...
    if (!message) {
        ...
        if (!defaultMessage ||
            ...
            // default locale.
            onError(new error/* MissingTranslationError */.sb(messageDescriptor, locale));
        }
        if (defaultMessage) {
            try {
                ...
                onError(new error/* MessageFormatError */.Ho("Error formatting default message for: \"".concat(id, "\", rendering default message verbatim"), locale, messageDescriptor, e));
    ...
    try {
        var formatter = state.getMessageFormat(message, locale, formats, (0,tslib_es6/* __assign */.Cl)({ formatters: state }, (opts || {})));
        return formatter.format(values);
    }
    catch (e) {
        onError(new error/* MessageFormatError */.Ho("Error formatting message: \"".concat(id, "\", using ").concat(defaultMessage ? 'default message' : 'id', " as fallback."), locale, messageDescriptor, e));
    }
    if (defaultMessage) {
        try {
            var formatter = state.getMessageFormat(defaultMessage, defaultLocale, defaultFormats, opts);
            ...
            onError(new error/* MessageFormatError */.Ho("Error formatting the default message for: \"".concat(id, "\", rendering message verbatim"), locale, messageDescriptor, e));
        }
    }
...
var src_utils = __webpack_require__(87683);
...
function getFormatter(_a, getNumberFormat, options) {
    ...
    var defaults = ((format &&
        (0,src_utils/* getNamedFormat */.F3)(formats, 'number', format, onError)) ||
        {});
    var filteredOptions = (0,src_utils/* filterProps */.J9)(options, NUMBER_FORMAT_OPTIONS, defaults);
...
function formatNumber(config, getNumberFormat, value, options) {
    ...
    try {
        ...
        config.onError(new error/* IntlFormatError */.pg('Error formatting number.', config.locale, e));
    }
    return String(value);
}
...
var src_error = __webpack_require__(11732);
...
function relativeTime_getFormatter(_a, getRelativeTimeFormat, options) {
    ...
    if (options === void 0) { options = {}; }
    var format = options.format;
    var defaults = (!!format && (0,src_utils/* getNamedFormat */.F3)(formats, 'relative', format, onError)) || {};
    var filteredOptions = (0,src_utils/* filterProps */.J9)(options, RELATIVE_TIME_FORMAT_OPTIONS, defaults);
...
function formatRelativeTime(config, getRelativeTimeFormat, value, unit, options) {
    ...
    if (!RelativeTimeFormat) {
        config.onError(new src_error/* FormatError */.IF("Intl.RelativeTimeFormat is not available in this environment.\nTry polyfilling it using \"@formatjs/intl-relativetimeformat\"\n", src_error/* ErrorCode */.O4.MISSING_INTL_API));
    }
    try {
        return relativeTime_getFormatter(config, getRelativeTimeFormat, options).format(value, unit);
    }
    catch (e) {
        config.onError(new error/* IntlFormatError */.pg('Error formatting relative time.', config.locale, e));
    }
    return String(value);
}
...
function dateTime_getFormatter(_a, type, getDateTimeFormat, options) {
    ...
    if (options === void 0) { options = {}; }
    var format = options.format;
    var defaults = (0,tslib_es6/* __assign */.Cl)((0,tslib_es6/* __assign */.Cl)({}, (timeZone && { timeZone: timeZone })), (format && (0,src_utils/* getNamedFormat */.F3)(formats, type, format, onError)));
    var filteredOptions = (0,src_utils/* filterProps */.J9)(options, DATE_TIME_FORMAT_OPTIONS, defaults);
    if (type === 'time' &&
        ...
        filteredOptions = (0,tslib_es6/* __assign */.Cl)((0,tslib_es6/* __assign */.Cl)({}, filteredOptions), { hour: 'numeric', minute: 'numeric' });
    }
...
function formatDate(config, getDateTimeFormat) {
    ...
    try {
        ...
        config.onError(new error/* IntlFormatError */.pg('Error formatting date.', config.locale, e));
    }
    return String(date);
}
function formatTime(config, getDateTimeFormat) {
    ...
    try {
        ...
        config.onError(new error/* IntlFormatError */.pg('Error formatting time.', config.locale, e));
    }
    return String(date);
}
function formatDateTimeRange(config, getDateTimeFormat) {
    ...
    var filteredOptions = (0,src_utils/* filterProps */.J9)(options, DATE_TIME_FORMAT_OPTIONS, timeZone ? { timeZone: timeZone } : {});
    try {
        return getDateTimeFormat(locale, filteredOptions).formatRange(from, to);
    }
    catch (e) {
        onError(new error/* IntlFormatError */.pg('Error formatting date time range.', config.locale, e));
    }
    return String(from);
}
...
function formatPlural(_a, getPluralRules, value, options) {
    ...
    if (options === void 0) { options = {}; }
    if (!Intl.PluralRules) {
        onError(new src_error/* FormatError */.IF("Intl.PluralRules is not available in this environment.\nTry polyfilling it using \"@formatjs/intl-pluralrules\"\n", src_error/* ErrorCode */.O4.MISSING_INTL_API));
    }
    var filteredOptions = (0,src_utils/* filterProps */.J9)(options, PLURAL_FORMAT_OPTIONS);
    try {
        return getPluralRules(locale, filteredOptions).select(value);
    }
    catch (e) {
        onError(new error/* IntlFormatError */.pg('Error formatting plural.', locale, e));
    }
    return 'other';
}
...
function formatListToParts(_a, getListFormat, values, options) {
    ...
    if (!ListFormat) {
        onError(new src_error/* FormatError */.IF("Intl.ListFormat is not available in this environment.\nTry polyfilling it using \"@formatjs/intl-listformat\"\n", src_error/* ErrorCode */.O4.MISSING_INTL_API));
    }
    var filteredOptions = (0,src_utils/* filterProps */.J9)(options, LIST_FORMAT_OPTIONS);
    try {
        var richValues_1 = {};
        ...
        return getListFormat(locale, filteredOptions)
            ...
            return part.type === 'literal'
                ? part
                : (0,tslib_es6/* __assign */.Cl)((0,tslib_es6/* __assign */.Cl)({}, part), { value: richValues_1[part.value] || part.value });
        });
    }
    catch (e) {
        onError(new error/* IntlFormatError */.pg('Error formatting list.', locale, e));
    }
    // @ts-ignore
    return values;
}
...
function formatDisplayName(_a, getDisplayNames, value, options) {
    ...
    if (!DisplayNames) {
        onError(new src_error/* FormatError */.IF("Intl.DisplayNames is not available in this environment.\nTry polyfilling it using \"@formatjs/intl-displaynames\"\n", src_error/* ErrorCode */.O4.MISSING_INTL_API));
    }
    var filteredOptions = (0,src_utils/* filterProps */.J9)(options, DISPLAY_NAMES_OPTONS);
    try {
        return getDisplayNames(locale, filteredOptions).of(value);
    }
    catch (e) {
        onError(new error/* IntlFormatError */.pg('Error formatting display name.', locale, e));
    }
}
...
function createIntl(config, cache) {
    var formatters = (0,src_utils/* createFormatters */.GT)(cache);
    var resolvedConfig = (0,tslib_es6/* __assign */.Cl)((0,tslib_es6/* __assign */.Cl)({}, src_utils/* DEFAULT_INTL_CONFIG */.JF), config);
    var locale = resolvedConfig.locale, defaultLocale = resolvedConfig.defaultLocale, onError = resolvedConfig.onError;
    if (!locale) {
        if (onError) {
            onError(new error/* InvalidConfigError */.uo("\"locale\" was not configured, using \"".concat(defaultLocale, "\" as fallback. See https://formatjs.io/docs/react-intl/api#intlshape for more details")));
        }
        ...
        onError(new error/* MissingDataError */.hr("Missing locale data for locale: \"".concat(locale, "\" in Intl.NumberFormat. Using default locale: \"").concat(defaultLocale, "\" as fallback. See https://formatjs.io/docs/react-intl#runtime-requirements for more details")));
    }
    else if (!Intl.DateTimeFormat.supportedLocalesOf(locale).length &&
        onError) {
        onError(new error/* MissingDataError */.hr("Missing locale data for locale: \"".concat(locale, "\" in Intl.DateTimeFormat. Using default locale: \"").concat(defaultLocale, "\" as fallback. See https://formatjs.io/docs/react-intl#runtime-requirements for more details")));
    }
    verifyConfigMessages(resolvedConfig);
    return (0,tslib_es6/* __assign */.Cl)((0,tslib_es6/* __assign */.Cl)({}, resolvedConfig), { formatters: formatters, formatNumber: formatNumber.bind(null, resolvedConfig, formatters.getNumberFormat), formatNumberToParts: formatNumberToParts.bind(null, resolvedConfig, formatters.getNumberFormat), formatRelativeTime: formatRelativeTime.bind(null, resolvedConfig, formatters.getRelativeTimeFormat), formatDate: formatDate.bind(null, resolvedConfig, formatters.getDateTimeFormat), formatDateToParts: formatDateToParts.bind(null, resolvedConfig, formatters.getDateTimeFormat), formatTime: formatTime.bind(null, resolvedConfig, formatters.getDateTimeFormat), formatDateTimeRange: formatDateTimeRange.bind(null, resolvedConfig, formatters.getDateTimeFormat), formatTimeToParts: formatTimeToParts.bind(null, resolvedConfig, formatters.getDateTimeFormat), formatPlural: formatPlural.bind(null, resolvedConfig, formatters.getPluralRules), 
...
var formatters = __webpack_require__(31071);
...
function assignUniqueKeysToFormatXMLElementFnArgument(values) {
    ...
    return Object.keys(values).reduce(function (acc, k) {
        var v = values[k];
        acc[k] = (0,formatters/* isFormatXMLElementFn */.RK)(v)
            ? (0,utils/* assignUniqueKeysToParts */.yU)(v)
            : v;
        return acc;
    }, {});
}
var provider_formatMessage = function (config, formatters, descriptor, rawValues) {
    ...
    var chunks = formatMessage.apply(void 0, (0,tslib_es6/* __spreadArray */.fX)([config,
        formatters,
        descriptor,
        values], rest, false));
...
var provider_createIntl = function (_a, cache) {
    var rawDefaultRichTextElements = _a.defaultRichTextElements, config = (0,tslib_es6/* __rest */.Tt)(_a, ["defaultRichTextElements"]);
    var defaultRichTextElements = assignUniqueKeysToFormatXMLElementFnArgument(rawDefaultRichTextElements);
    var coreIntl = createIntl((0,tslib_es6/* __assign */.Cl)((0,tslib_es6/* __assign */.Cl)((0,tslib_es6/* __assign */.Cl)({}, utils/* DEFAULT_INTL_CONFIG */.JF), config), { defaultRichTextElements: defaultRichTextElements }), cache);
    var resolvedConfig = {
    ...
    return (0,tslib_es6/* __assign */.Cl)((0,tslib_es6/* __assign */.Cl)({}, coreIntl), { 
...
var IntlProvider = /** @class */ (function (_super) {
    (0,tslib_es6/* __extends */.C6)(IntlProvider, _super);
    function IntlProvider() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.cache = (0,src_utils/* createIntlCache */.MT)();
        _this.state = {
            cache: _this.cache,
    ...
    IntlProvider.getDerivedStateFromProps = function (props, _a) {
        ...
        if (!(0,utils/* shallowEqual */.bN)(prevConfig, config)) {
            return {
    ...
    IntlProvider.prototype.render = function () {
        (0,utils/* invariantIntlContext */.HM)(this.state.intl);
        return react.createElement(injectIntl/* Provider */.Kq, { value: this.state.intl }, this.props.children);
    };
    IntlProvider.displayName = 'IntlProvider';
    IntlProvider.defaultProps = utils/* DEFAULT_INTL_CONFIG */.JF;
    return IntlProvider;
}(react.PureComponent));
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   o: () => (/* binding */ SkipToContent)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(74848);
/* harmony import */ var styled_components__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(40948);
/* harmony import */ var _Box_Box_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(17715);
...
const AnchorBox = (0,styled_components__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Ay)((0,_Box_Box_mjs__WEBPACK_IMPORTED_MODULE_2__/* .Box */ .a)) `
...
var common_theme = __webpack_require__(36234);
