"use strict";
(self["webpackChunkmy_project"] = self["webpackChunkmy_project"] || []).push([[5472],{
...
const Tr_Tr = styled_components_browser_esm/* default */.Ay.tr`
  &.component-row,
  &.dynamiczone-row {
    position: relative;
    ...
    > td:first-of-type {
      padding: 0 0 0 ${(0,helper_plugin_esm/* pxToRem */.a8)(20)};
      position: relative;

      &::before {
        content: '';
        width: ${(0,helper_plugin_esm/* pxToRem */.a8)(4)};
...
function ComponentIcon({ isActive, icon }) {
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Icon/* Icon */.I, { as: constants/* COMPONENT_ICONS */.z[icon] || constants/* COMPONENT_ICONS */.z.cube, height: 5, width: 5 })
  );
}
...
const CloseButton = (0,styled_components_browser_esm/* default */.Ay)((0,Box/* Box */.a))`
  position: absolute;
  display: none;
  top: 5px;
  right: ${(0,helper_plugin_esm/* pxToRem */.a8)(8)};

  svg {
    width: ${(0,helper_plugin_esm/* pxToRem */.a8)(10)};
    height: ${(0,helper_plugin_esm/* pxToRem */.a8)(10)};
...
const ComponentBox = (0,styled_components_browser_esm/* default */.Ay)((0,Flex/* Flex */.s))`
  width: ${(0,helper_plugin_esm/* pxToRem */.a8)(140)};
  height: ${(0,helper_plugin_esm/* pxToRem */.a8)(80)};
  position: relative;
...
function ComponentCard({ component, dzName, index, isActive, isInDevelopmentMode, onClick }) {
  const { modifiedData, removeComponentFromDynamicZone } = (0,useDataManager/* default */.A)();
  const {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Box/* Box */.a, { marginTop: 1, maxWidth: "100%" }, /* @__PURE__ */ react.createElement(Typography/* Typography */.o, { variant: "pi", fontWeight: "bold", ellipsis: true }, displayName)),
    isInDevelopmentMode && /* @__PURE__ */ react.createElement(CloseButton, { as: "button", onClick: onClose }, /* @__PURE__ */ react.createElement(Cross/* default */.A, null))
  );
}
...
const StyledAddIcon = (0,styled_components_browser_esm/* default */.Ay)((0,Plus/* default */.A))`
  width: ${(0,helper_plugin_esm/* pxToRem */.a8)(32)};
  height: ${(0,helper_plugin_esm/* pxToRem */.a8)(32)};
  padding: ${(0,helper_plugin_esm/* pxToRem */.a8)(9)};
  border-radius: ${(0,helper_plugin_esm/* pxToRem */.a8)(64)};
  background: ${({ theme }) => theme.colors.primary100};
  path {
    fill: ${({ theme }) => theme.colors.primary600};
  }
`;
const FixedBox = (0,styled_components_browser_esm/* default */.Ay)((0,Box/* Box */.a))`
  height: ${(0,helper_plugin_esm/* pxToRem */.a8)(90)};
  position: absolute;
  width: 100%;
  top: 0;
  left: 0;
`;
const ScrollableStack = (0,styled_components_browser_esm/* default */.Ay)((0,Flex/* Flex */.s))`
  width: 100%;
  overflow-x: auto;
`;
const ComponentContentBox = (0,styled_components_browser_esm/* default */.Ay)((0,Box/* Box */.a))`
  padding-top: ${(0,helper_plugin_esm/* pxToRem */.a8)(90)};
`;
const ComponentStack = (0,styled_components_browser_esm/* default */.Ay)((0,Flex/* Flex */.s))`
  flex-shrink: 0;
  width: ${(0,helper_plugin_esm/* pxToRem */.a8)(140)};
  height: ${(0,helper_plugin_esm/* pxToRem */.a8)(80)};
...
function DynamicZoneList({ customRowComponent, components, addComponent, name, targetUid }) {
  const { isInDevelopmentMode } = (0,useDataManager/* default */.A)();
...
`;
const ButtonBox = (0,styled_components_browser_esm/* default */.Ay)((0,Box/* Box */.a))`
...
const NestedTFooter = ({ children, icon, color, ...props }) => {
  return /* @__PURE__ */ react.createElement(ButtonBox, { paddingBottom: 4, paddingTop: 4, as: "button", type: "button", ...props }, /* @__PURE__ */ react.createElement(Flex/* Flex */.s, null, /* @__PURE__ */ react.createElement(IconBox, { color, "aria-hidden": true, background: `${color}200` }, icon), /* @__PURE__ */ react.createElement(Box/* Box */.a, { paddingLeft: 3 }, /* @__PURE__ */ react.createElement(Typography/* Typography */.o, { variant: "pi", fontWeight: "bold", textColor: `${color}600` }, children))));
};
...
function List({
  ...
  const { isInDevelopmentMode, modifiedData, isInContentTypeView } = (0,useDataManager/* default */.A)();
  ...
  if (!targetUid) {
    return /* @__PURE__ */ react.createElement(Table/* Table */.X, { colCount: 2, rowCount: 2 }, /* @__PURE__ */ react.createElement(Thead/* Thead */.d, null, /* @__PURE__ */ react.createElement(Tr.Tr, null, /* @__PURE__ */ react.createElement(Cell.Th, null, /* @__PURE__ */ react.createElement(Typography/* Typography */.o, { variant: "sigma", textColor: "neutral600" }, formatMessage({ id: "global.name", defaultMessage: "Name" }))), /* @__PURE__ */ react.createElement(Cell.Th, null, /* @__PURE__ */ react.createElement(Typography/* Typography */.o, { variant: "sigma", textColor: "neutral600" }, formatMessage({ id: "global.type", defaultMessage: "Type" }))))), /* @__PURE__ */ react.createElement(
      helper_plugin_esm/* EmptyBodyTable */.m5,
      {
        colSpan: 2,
        content: {
          id: (0,getTrad/* default */.A)("table.content.create-first-content-type"),
  ...
  if (items.length === 0 && isMain) {
    return /* @__PURE__ */ react.createElement(Table/* Table */.X, { colCount: 2, rowCount: 2 }, /* @__PURE__ */ react.createElement(Thead/* Thead */.d, null, /* @__PURE__ */ react.createElement(Tr.Tr, null, /* @__PURE__ */ react.createElement(Cell.Th, null, /* @__PURE__ */ react.createElement(Typography/* Typography */.o, { variant: "sigma", textColor: "neutral600" }, formatMessage({ id: "global.name", defaultMessage: "Name" }))), /* @__PURE__ */ react.createElement(Cell.Th, null, /* @__PURE__ */ react.createElement(Typography/* Typography */.o, { variant: "sigma", textColor: "neutral600" }, formatMessage({ id: "global.type", defaultMessage: "Type" }))))), /* @__PURE__ */ react.createElement(
      helper_plugin_esm/* EmptyBodyTable */.m5,
      {
        action: /* @__PURE__ */ react.createElement(Button/* Button */.$, { onClick: onClickAddField, size: "L", startIcon: /* @__PURE__ */ react.createElement(Plus/* default */.A, null), variant: "secondary" }, formatMessage({
          id: (0,getTrad/* default */.A)("table.button.no-fields"),
          defaultMessage: "Add new field"
        })),
        colSpan: 2,
        content: isInContentTypeView ? {
          id: (0,getTrad/* default */.A)("table.content.no-fields.collection-type"),
          defaultMessage: "Add your first field to this Collection-Type"
        } : {
          id: (0,getTrad/* default */.A)("table.content.no-fields.component"),
  ...
  return /* @__PURE__ */ react.createElement(List_BoxWrapper, null, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement("table", null, isMain && /* @__PURE__ */ react.createElement("thead", null, /* @__PURE__ */ react.createElement("tr", null, /* @__PURE__ */ react.createElement("th", null, /* @__PURE__ */ react.createElement(Typography/* Typography */.o, { variant: "sigma", textColor: "neutral600" }, formatMessage({ id: "global.name", defaultMessage: "Name" }))), /* @__PURE__ */ react.createElement("th", { colSpan: "2" }, /* @__PURE__ */ react.createElement(Typography/* Typography */.o, { variant: "sigma", textColor: "neutral600" }, formatMessage({ id: "global.type", defaultMessage: "Type" }))))), /* @__PURE__ */ react.createElement("tbody", null, items.map((item) => {
      const { type } = item;
  ...
  ), isMain && isInDevelopmentMode && /* @__PURE__ */ react.createElement(TFooter/* TFooter */.S, { icon: /* @__PURE__ */ react.createElement(Plus/* default */.A, null), onClick: onClickAddField }, formatMessage({
    ...
    formatMessage({
      id: (0,getTrad/* default */.A)(`form.button.add.field.to.component`),
      defaultMessage: "Add another field"
    })
  ));
}
...
const BoxWrapper_BoxWrapper = (0,styled_components_browser_esm/* default */.Ay)((0,Box/* Box */.a))`
  position: relative;
`;
...
const DisplayedType = ({ type, customField, repeatable }) => {
  ...
  if (customField) {
    return /* @__PURE__ */ react.createElement(Typography/* Typography */.o, null, formatMessage({
      id: (0,getTrad/* default */.A)("attribute.customField"),
      defaultMessage: "Custom field"
    }));
  }
  return /* @__PURE__ */ react.createElement(Typography/* Typography */.o, null, formatMessage({
    id: (0,getTrad/* default */.A)(`attribute.${readableType}`),
    defaultMessage: type
  }), "\xA0", repeatable && formatMessage({
    id: (0,getTrad/* default */.A)("component.repeatable"),
...
function ListRow({
  ...
  const { contentTypes, isInDevelopmentMode, removeAttribute } = (0,useDataManager/* default */.A)();
  const { formatMessage } = (0,useIntl/* default */.A)();
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement("td", { style: { position: "relative" } }, loopNumber !== 0 && /* @__PURE__ */ react.createElement(icons_Curve, { color: isFromDynamicZone ? "primary200" : "neutral150" }), /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { paddingLeft: 2, gap: 4 }, /* @__PURE__ */ react.createElement(AttributeIcon/* default */.A, { type: src, customField }), /* @__PURE__ */ react.createElement(Typography/* Typography */.o, { fontWeight: "bold" }, name))),
    /* @__PURE__ */ react.createElement("td", null, target ? /* @__PURE__ */ react.createElement(Typography/* Typography */.o, null, formatMessage({
      id: (0,getTrad/* default */.A)(
      ...
      id: (0,getTrad/* default */.A)(`from`),
      defaultMessage: "from"
    })}: ${isPluginContentType})`)) : /* @__PURE__ */ react.createElement(ListRow_DisplayedType, { type, customField, repeatable })),
    /* @__PURE__ */ react.createElement("td", null, isInDevelopmentMode ? /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { justifyContent: "flex-end", ...helper_plugin_esm/* stopPropagation */.dG }, configurable ? /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { gap: 1 }, !isMorph && /* @__PURE__ */ react.createElement(
    ...
    )) : /* @__PURE__ */ react.createElement(Lock/* default */.A, null)) : (
      /*
      ...
      */
      /* @__PURE__ */ react.createElement(Box/* Box */.a, { height: (0,helper_plugin_esm/* pxToRem */.a8)(32) })
    ))
  );
}
...
const LinkToCMSettingsView = ({
  ...
  return /* @__PURE__ */ react.createElement(helper_plugin_esm/* CheckPermissions */.d4, { permissions: permissionsToApply }, /* @__PURE__ */ react.createElement(
    Button/* Button */.$,
    {
...
const ListView = () => {
  const { initialData, modifiedData, isInDevelopmentMode, isInContentTypeView, submitData } = (0,useDataManager/* default */.A)();
  const { formatMessage } = (0,useIntl/* default */.A)();
  const { trackUsage } = (0,helper_plugin_esm/* useTracking */.z1)();
  const match = (0,react_router/* useRouteMatch */.W5)("/plugins/content-type-builder/:kind/:currentUID");
  const {
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(
    ...
    {
      message: (location) => location.hash === "#back" ? false : formatMessage({ id: (0,getTrad/* default */.A)("prompt.unsaved") }),
    ...
    {
      id: "title",
      primaryAction: isInDevelopmentMode && /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { gap: 2 }, !isCreatingFirstContentType && /* @__PURE__ */ react.createElement(
        Button/* Button */.$,
        {
        ...
        formatMessage({ id: (0,getTrad/* default */.A)("button.attributes.add.another") })
      ), /* @__PURE__ */ react.createElement(
        Button/* Button */.$,
        {
      ...
      secondaryAction: isInDevelopmentMode && !isFromPlugin && !isCreatingFirstContentType && /* @__PURE__ */ react.createElement(Button/* Button */.$, { startIcon: /* @__PURE__ */ react.createElement(Pencil/* default */.A, null), variant: "tertiary", onClick: onEdit }, formatMessage({
        id: "app.utils.edit",
        defaultMessage: "Edit"
      })),
      title: upperFirst_default()(label),
      subtitle: formatMessage({
        id: (0,getTrad/* default */.A)("listView.headerLayout.description"),
        defaultMessage: "Build the data architecture of your content"
      }),
      navigationAction: /* @__PURE__ */ react.createElement(helper_plugin_esm/* Link */.N_, { startIcon: /* @__PURE__ */ react.createElement(ArrowLeft/* default */.A, null), to: "/plugins/content-type-builder/" }, formatMessage({
        id: "global.back",
        defaultMessage: "Back"
      }))
    }
  ), /* @__PURE__ */ react.createElement(ContentLayout/* ContentLayout */.s, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { direction: "column", alignItems: "stretch", gap: 4 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { justifyContent: "flex-end" }, /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { gap: 2 }, /* @__PURE__ */ react.createElement(
  ...
  ))), /* @__PURE__ */ react.createElement(Box/* Box */.a, { background: "neutral0", shadow: "filterShadow", hasRadius: true }, /* @__PURE__ */ react.createElement(
    components_List,
    {
      items: attributes,
