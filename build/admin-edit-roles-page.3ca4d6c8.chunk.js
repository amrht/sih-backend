(self["webpackChunkmy_project"] = self["webpackChunkmy_project"] || []).push([[6823],{
...
/* harmony export */   R: () => (/* binding */ useAdminRolePermissions)
/* harmony export */ });
...
var useAdminRolePermissions = __webpack_require__(42537);
...
const UsersRoleNumber = styled_components_browser_esm/* default */.Ay.div`
...
`;
const CreatePage = () => {
  const route = (0,react_router/* useRouteMatch */.W5)("/settings/roles/duplicate/:id");
  ...
  const { post, put } = (0,helper_plugin_esm/* useFetchClient */.ry)();
  const { params } = route ?? {};
  const { isLoading: isLoadingPermissionsLayout, data: permissionsLayout } = (0,useAdminRolePermissionLayout/* useAdminRolePermissionLayout */.K)(params?.id, {
    cacheTime: 0
  });
  const { permissions: rolePermissions, isLoading: isLoadingRole } = (0,useAdminRolePermissions/* useAdminRolePermissions */.R)(
    { id: params?.id },
    {
      cacheTime: 0,
  ...
  })} ${(0,format/* default */.A)(new Date(), "PPP")}`;
  return /* @__PURE__ */ react.createElement(Main/* Main */.g, null, /* @__PURE__ */ react.createElement(helper_plugin_esm/* SettingsPageTitle */.x7, { name: "Roles" }), /* @__PURE__ */ react.createElement(
    ...
    ({ handleSubmit, values, errors, handleReset, handleChange }) => /* @__PURE__ */ react.createElement(helper_plugin_esm/* Form */.lV, { noValidate: true }, /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(
      HeaderLayout/* HeaderLayout */.Q,
      {
        ...
        navigationAction: /* @__PURE__ */ react.createElement(helper_plugin_esm/* Link */.N_, { startIcon: /* @__PURE__ */ react.createElement(ArrowLeft/* default */.A, null), to: "/settings/roles" }, formatMessage({
          id: "global.back",
          defaultMessage: "Back"
        }))
      }
    ), /* @__PURE__ */ react.createElement(ContentLayout/* ContentLayout */.s, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { direction: "column", alignItems: "stretch", gap: 6 }, /* @__PURE__ */ react.createElement(Box/* Box */.a, { background: "neutral0", padding: 6, shadow: "filterShadow", hasRadius: true }, /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { direction: "column", alignItems: "stretch", gap: 4 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(Box/* Box */.a, null, /* @__PURE__ */ react.createElement(Box/* Box */.a, null, /* @__PURE__ */ react.createElement(Typography/* Typography */.o, { fontWeight: "bold" }, formatMessage({
      id: "global.details",
      ...
      values.description
    ))))), !isLoadingPermissionsLayout && !isLoadingRole ? /* @__PURE__ */ react.createElement(Box/* Box */.a, { shadow: "filterShadow", hasRadius: true }, /* @__PURE__ */ react.createElement(
    ...
    )) : /* @__PURE__ */ react.createElement(Box/* Box */.a, { background: "neutral0", padding: 6, shadow: "filterShadow", hasRadius: true }, /* @__PURE__ */ react.createElement(helper_plugin_esm/* LoadingIndicatorPage */.Bl, null))))))
  ));
};
/* harmony default export */ function Roles_CreatePage() {
  const permissions = (0,es/* useSelector */.d4)(selectors/* selectAdminPermissions */.G);
  return /* @__PURE__ */ react.createElement(helper_plugin_esm/* CheckPagePermissions */.kz, { permissions: permissions.settings.roles.create }, /* @__PURE__ */ react.createElement(CreatePage, null));
}
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  A: () => (/* binding */ components_Permissions)
});
...
var ChevronUp = __webpack_require__(61482);
// EXTERNAL MODULE: ./node_modules/@strapi/icons/dist/ChevronDown.mjs
var ChevronDown = __webpack_require__(20005);
...
const Wrapper = styled_components_browser_esm/* default */.Ay.div`
  position: relative;
...
const ConditionsButton = ({ onClick, className, hasConditions, variant }) => {
  const { formatMessage } = (0,useIntl/* default */.A)();
  return /* @__PURE__ */ react.createElement(Wrapper, { hasConditions, className }, /* @__PURE__ */ react.createElement(Button/* Button */.$, { variant, startIcon: /* @__PURE__ */ react.createElement(Cog/* default */.A, null), onClick }, formatMessage({
    id: "global.settings",
...
/* harmony default export */ const components_ConditionsButton = ((0,styled_components_browser_esm/* default */.Ay)(ConditionsButton)``);
...
const ActionRow = ({
  ...
  return /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { as: "li", background: isGrey ? "neutral100" : "neutral0", paddingBottom: 3, paddingTop: 3 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { paddingLeft: 6, style: { width: 180 } }, /* @__PURE__ */ react.createElement(Typography/* Typography */.o, { variant: "sigma", textColor: "neutral600" }, formatMessage({
    id: "Settings.permissions.conditions.can",
    defaultMessage: "Can"
  }), "\xA0"), /* @__PURE__ */ react.createElement(Typography/* Typography */.o, { variant: "sigma", title: label, textColor: "primary600", ellipsis: true }, formatMessage({
    id: `Settings.roles.form.permissions.${label.toLowerCase()}`,
    defaultMessage: label
  })), /* @__PURE__ */ react.createElement(Typography/* Typography */.o, { variant: "sigma", textColor: "neutral600" }, "\xA0", formatMessage({
    id: "Settings.permissions.conditions.when",
    defaultMessage: "When"
  }))), /* @__PURE__ */ react.createElement(Box/* Box */.a, { style: { maxWidth: 430, width: "100%" } }, /* @__PURE__ */ react.createElement(
...
const ConditionsModal = ({ actions, headerBreadCrumbs, isFormDisabled, onClosed, onToggle }) => {
  const { formatMessage } = (0,useIntl/* default */.A)();
  const { availableConditions, modifiedData, onChangeConditions } = (0,hooks/* usePermissionsDataManager */.pn)();
  ...
  return /* @__PURE__ */ react.createElement(ModalLayout/* ModalLayout */.k, { labelledBy: "condition-modal-breadcrumbs", onClose: onClosed }, /* @__PURE__ */ react.createElement(ModalHeader/* ModalHeader */.r, null, /* @__PURE__ */ react.createElement(Breadcrumbs/* Breadcrumbs */.B, { id: "condition-modal-breadcrumbs", label: headerBreadCrumbs.join(", ") }, headerBreadCrumbs.map((label, index, arr) => /* @__PURE__ */ react.createElement(Crumb/* Crumb */.m, { isCurrent: index === arr.length - 1, key: label }, upperFirst_default()(
    formatMessage({
      id: label,
      defaultMessage: label
    })
  ))))), /* @__PURE__ */ react.createElement(ModalBody/* ModalBody */.c, null, actionsToDisplay.length === 0 && /* @__PURE__ */ react.createElement(Typography/* Typography */.o, null, formatMessage({
...
const HiddenAction = styled_components_browser_esm/* default */.Ay.div`
  width: ${cellWidth};
`;
...
const CollapseLabel = (0,styled_components_browser_esm/* default */.Ay)((0,Flex/* Flex */.s))`
...
const RowLabelWithCheckbox = ({
  ...
  const { formatMessage } = (0,useIntl/* default */.A)();
  return /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { alignItems: "center", paddingLeft: 6, style: { width: firstRowWidth, flexShrink: 0 } }, /* @__PURE__ */ react.createElement(Box/* Box */.a, { paddingRight: 2 }, /* @__PURE__ */ react.createElement(
...
const CarretIcon = (0,styled_components_browser_esm/* default */.Ay)((0,CarretDown/* default */.A))`
  display: none;
  width: ${10 / 16}rem;
...
`;
const Collapse_Wrapper = styled_components_browser_esm/* default */.Ay.div`
  flex: 1;
  display: flex;
  align-items: center;
  height: ${rowHeight};
...
`;
const BoxWrapper = styled_components_browser_esm/* default */.Ay.div`
  display: inline-flex;
  min-width: 100%;
...
`;
const Cell = (0,styled_components_browser_esm/* default */.Ay)((0,Flex/* Flex */.s))`
  width: ${cellWidth};
  position: relative;
`;
const Chevron = (0,styled_components_browser_esm/* default */.Ay)((0,Box/* Box */.a))`
  display: none;
  svg {
    width: 11px;
  }
...
`;
const TinyDot = styled_components_browser_esm/* default */.Ay.span`
  position: absolute;
  top: -6px;
  left: 37px;
  width: 6px;
...
`;
const AbsoluteBox = (0,styled_components_browser_esm/* default */.Ay)((0,Box/* Box */.a))`
  position: absolute;
  right: 9px;
...
const Collapse = ({
  ...
  const { formatMessage } = (0,useIntl/* default */.A)();
  const { modifiedData, onChangeParentCheckbox, onChangeSimpleCheckbox } = (0,hooks/* usePermissionsDataManager */.pn)();
  ...
  return /* @__PURE__ */ react.createElement(BoxWrapper, { isActive }, /* @__PURE__ */ react.createElement(Collapse_Wrapper, { isGrey }, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Chevron, { paddingLeft: 2 }, isActive ? /* @__PURE__ */ react.createElement(ChevronUp/* default */.A, null) : /* @__PURE__ */ react.createElement(ChevronDown/* default */.A, null))
  ), /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { style: { flex: 1 } }, checkboxesActions.map(
    ({
      actionId,
      hasConditions,
...
const Required = styled_components_browser_esm/* default */.Ay.span`
...
`;
const Svg = styled_components_browser_esm/* default */.Ay.svg`
  position: relative;
  flex-shrink: 0;
...
const SubActionRow_Cell = (0,styled_components_browser_esm/* default */.Ay)((0,Flex/* Flex */.s))`
  width: ${cellWidth};
  position: relative;
`;
const RowWrapper = (0,styled_components_browser_esm/* default */.Ay)((0,Flex/* Flex */.s))`
  height: ${rowHeight};
`;
const SubActionRow_Wrapper = (0,styled_components_browser_esm/* default */.Ay)((0,Box/* Box */.a))`
  padding-left: ${31 / 16}rem;
`;
const LeftBorderTimeline = (0,styled_components_browser_esm/* default */.Ay)((0,Box/* Box */.a))`
  border-left: ${({ isVisible, theme }) => isVisible ? `4px solid ${theme.colors.primary200}` : "4px solid transparent"};
`;
const RowStyle = (0,styled_components_browser_esm/* default */.Ay)((0,Flex/* Flex */.s))`
...
`;
const TopTimeline = styled_components_browser_esm/* default */.Ay.div`
...
const SubActionRow = ({
  ...
  return /* @__PURE__ */ react.createElement(SubActionRow_Wrapper, null, /* @__PURE__ */ react.createElement(TopTimeline, null), childrenForm.map(({ label, value, required, children: subChildrenForm }, index) => {
    ...
    return /* @__PURE__ */ react.createElement(LeftBorderTimeline, { key: value, isVisible }, /* @__PURE__ */ react.createElement(RowWrapper, null, /* @__PURE__ */ react.createElement(components_Curve, { color: "primary200" }), /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { style: { flex: 1 } }, /* @__PURE__ */ react.createElement(RowStyle, { level: recursiveLevel, isActive, isCollapsable: isArrayType }, /* @__PURE__ */ react.createElement(
      components_CollapseLabel,
      {
        alignItems: "center",
      ...
      /* @__PURE__ */ react.createElement(Typography/* Typography */.o, { ellipsis: true }, upperFirst_default()(label)),
    ...
    )), /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { style: { flex: 1 } }, propertyActions.map(
    ...
    )))), displayedRecursiveChildren && isActive && /* @__PURE__ */ react.createElement(Box/* Box */.a, { paddingBottom: 2 }, /* @__PURE__ */ react.createElement(
      SubActionRow,
      {
        isFormDisabled,
...
const ActionRow_Cell = (0,styled_components_browser_esm/* default */.Ay)((0,Flex/* Flex */.s))`
  width: ${cellWidth};
  position: relative;
`;
const ActionRow_Wrapper = (0,styled_components_browser_esm/* default */.Ay)((0,Flex/* Flex */.s))`
  height: ${rowHeight};
  flex: 1;
...
const ActionRow_ActionRow = ({
  ...
  const {
    ...
    onChangeParentCheckbox,
    onChangeSimpleCheckbox
  } = (0,hooks/* usePermissionsDataManager */.pn)();
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Flex/* Flex */.s, null, /* @__PURE__ */ react.createElement(
      components_RowLabelWithCheckbox,
      {
      ...
      required && /* @__PURE__ */ react.createElement(components_RequiredSign, null),
      /* @__PURE__ */ react.createElement(CollapsePropertyMatrix_CarretIcon, { $isActive: isActive })
    ), /* @__PURE__ */ react.createElement(Flex/* Flex */.s, null, propertyActions.map(({ label: label2, isActionRelatedToCurrentProperty, actionId }) => {
      if (!isActionRelatedToCurrentProperty) {
...
const HeaderLabel = (0,styled_components_browser_esm/* default */.Ay)((0,Flex/* Flex */.s))`
  width: ${cellWidth};
  flex-shrink: 0;
`;
const PropertyLabelWrapper = (0,styled_components_browser_esm/* default */.Ay)((0,Flex/* Flex */.s))`
  width: ${firstRowWidth};
  height: ${rowHeight};
  flex-shrink: 0;
`;
const Header = ({ headers, label }) => {
  ...
  return /* @__PURE__ */ react.createElement(Flex/* Flex */.s, null, /* @__PURE__ */ react.createElement(PropertyLabelWrapper, { alignItems: "center", paddingLeft: 6 }, /* @__PURE__ */ react.createElement(Typography/* Typography */.o, { variant: "sigma", textColor: "neutral500" }, translatedLabel)), headers.map((header) => {
    if (!header.isActionRelatedToCurrentProperty) {
      return /* @__PURE__ */ react.createElement(HeaderLabel, { key: header.label });
    }
    return /* @__PURE__ */ react.createElement(HeaderLabel, { justifyContent: "center", key: header.label }, /* @__PURE__ */ react.createElement(Typography/* Typography */.o, { variant: "sigma", textColor: "neutral500" }, formatMessage({
...
const CollapsePropertyMatrix_Wrapper = styled_components_browser_esm/* default */.Ay.div`
  display: inline-flex;
...
const ContentTypeCollapse_Wrapper = styled_components_browser_esm/* default */.Ay.div`
  flex-direction: column;
  display: inline-flex;
  min-width: 100%;
...
const CenteredStack = (0,styled_components_browser_esm/* default */.Ay)((0,Flex/* Flex */.s))`
  width: ${cellWidth};
  flex-shrink: 0;
`;
const GlobalActions = ({ actions, isFormDisabled, kind }) => {
  const { formatMessage } = (0,useIntl/* default */.A)();
  const { modifiedData, onChangeCollectionTypeGlobalActionCheckbox } = (0,hooks/* usePermissionsDataManager */.pn)();
  ...
  return /* @__PURE__ */ react.createElement(Box/* Box */.a, { paddingBottom: 4, paddingTop: 6, style: { paddingLeft: firstRowWidth } }, /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { gap: 0 }, displayedActions.map(({ label, actionId }) => {
    return /* @__PURE__ */ react.createElement(
      CenteredStack,
      {
        direction: "column",
      ...
      /* @__PURE__ */ react.createElement(Typography/* Typography */.o, { variant: "sigma", textColor: "neutral500" }, formatMessage({
        id: `Settings.roles.form.permissions.${label.toLowerCase()}`,
        defaultMessage: label
      })),
      /* @__PURE__ */ react.createElement(
...
const ContentTypes_StyledBox = (0,styled_components_browser_esm/* default */.Ay)((0,Box/* Box */.a))`
  overflow-x: auto;
`;
...
const PermissionsDataManagerProvider = ({ children, value }) => {
  return /* @__PURE__ */ react.createElement(contexts/* PermissionsDataManagerContext */.he.Provider, { value }, children);
};
...
`;
const CheckboxWrapper = styled_components_browser_esm/* default */.Ay.div`
  position: relative;
  word-break: keep-all;
  ${({ hasConditions, disabled, theme }) => hasConditions && `
    &:before {
...
const SubCategory = ({ categoryName, isFormDisabled, subCategoryName, actions, pathToData }) => {
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Box/* Box */.a, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { justifyContent: "space-between", alignItems: "center" }, /* @__PURE__ */ react.createElement(Box/* Box */.a, { paddingRight: 4 }, /* @__PURE__ */ react.createElement(Typography/* Typography */.o, { variant: "sigma", textColor: "neutral600" }, subCategoryName)), /* @__PURE__ */ react.createElement(Border, null), /* @__PURE__ */ react.createElement(Box/* Box */.a, { paddingLeft: 4 }, /* @__PURE__ */ react.createElement(
    Checkbox/* Checkbox */.S,
    {
  ...
  ))), /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { paddingTop: 6, paddingBottom: 6 }, /* @__PURE__ */ react.createElement(Grid/* Grid */.x, { gap: 2, style: { flex: 1 } }, formattedActions.map(({ checkboxName, value, action, displayName, hasConditions }) => {
    return /* @__PURE__ */ react.createElement(GridItem/* GridItem */.E, { col: 3, key: action }, /* @__PURE__ */ react.createElement(CheckboxWrapper, { disabled: isFormDisabled, hasConditions }, /* @__PURE__ */ react.createElement(
      Checkbox/* Checkbox */.S,
      {
        name: checkboxName,
        disabled: isFormDisabled,
...
const PermissionRow = ({
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(AccordionContent/* AccordionContent */.u, null, /* @__PURE__ */ react.createElement(Box/* Box */.a, { padding: 6 }, childrenForm.map(({ actions, subCategoryName, subCategoryId }) => /* @__PURE__ */ react.createElement(
...
const PluginsAndSettingsPermissions = ({ isFormDisabled, kind, layout }) => {
  ...
  return /* @__PURE__ */ react.createElement(Box/* Box */.a, { padding: 6, background: "neutral0" }, layout.map(({ category, categoryId, childrenForm }, index) => {
    return /* @__PURE__ */ react.createElement(
      Row,
      {
        key: category,
...
const Permissions = (0,react.forwardRef)(({ layout, isFormDisabled, permissions }, ref) => {
  ...
  (0,react.useImperativeHandle)(ref, () => {
    return {
      getPermissions() {
        const collectionTypesDiff = (0,helper_plugin_esm/* difference */.iv)(
          initialData.collectionTypes,
          modifiedData.collectionTypes
        );
        const singleTypesDiff = (0,helper_plugin_esm/* difference */.iv)(initialData.singleTypes, modifiedData.singleTypes);
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(
      ...
      /* @__PURE__ */ react.createElement(Tabs/* Tabs */.t, null, tabLabels.map((tabLabel) => /* @__PURE__ */ react.createElement(Tabs/* Tab */.o, { key: tabLabel.id }, formatMessage({ id: tabLabel.labelId, defaultMessage: tabLabel.defaultMessage })))),
      /* @__PURE__ */ react.createElement(TabPanels/* TabPanels */.T, { style: { position: "relative" } }, /* @__PURE__ */ react.createElement(TabPanels/* TabPanel */.K, null, /* @__PURE__ */ react.createElement(
...
const RoleForm = ({ disabled, role, values, errors, onChange, onBlur }) => {
  const { formatMessage } = (0,useIntl/* default */.A)();
  return /* @__PURE__ */ react.createElement(Box/* Box */.a, { background: "neutral0", padding: 6, shadow: "filterShadow", hasRadius: true }, /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { direction: "column", alignItems: "stretch", gap: 4 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(Box/* Box */.a, null, /* @__PURE__ */ react.createElement(Box/* Box */.a, null, /* @__PURE__ */ react.createElement(Typography/* Typography */.o, { fontWeight: "bold" }, role ? role.name : formatMessage({
    id: "global.details",
    defaultMessage: "Details"
  }))), /* @__PURE__ */ react.createElement(Box/* Box */.a, null, /* @__PURE__ */ react.createElement(Typography/* Typography */.o, { textColor: "neutral500", variant: "pi" }, role ? role.description : formatMessage({
    id: "Settings.roles.form.description",
    defaultMessage: "Name and description of the role"
...
const EditPage = () => {
  ...
  const {
    params: { id }
  } = (0,react_router/* useRouteMatch */.W5)("/settings/roles/:id");
  ...
  const { isLoading: isLoadingPermissionsLayout, data: permissionsLayout } = (0,useAdminRolePermissionLayout/* useAdminRolePermissionLayout */.K)(id, {
    cacheTime: 0
  });
  const {
    roles: [role = {}],
  ...
  const { permissions, isLoading: isLoadingPermissions } = (0,useAdminRolePermissions/* useAdminRolePermissions */.R)(
    { id },
    {
      cacheTime: 0
    }
  ...
  return /* @__PURE__ */ react.createElement(Main/* Main */.g, null, /* @__PURE__ */ react.createElement(helper_plugin_esm/* SettingsPageTitle */.x7, { name: "Roles" }), /* @__PURE__ */ react.createElement(
    ...
    ), !isLoadingPermissionsLayout && !isRoleLoading && !isLoadingPermissions ? /* @__PURE__ */ react.createElement(Box/* Box */.a, { shadow: "filterShadow", hasRadius: true }, /* @__PURE__ */ react.createElement(
      Permissions/* default */.A,
      {
        isFormDisabled,
        permissions,
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   K: () => (/* binding */ useAdminRolePermissionLayout)
/* harmony export */ });
/* harmony import */ var _strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(39150);
/* harmony import */ var react_query__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(75942);
