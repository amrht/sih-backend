"use strict";
(self["webpackChunkmy_project"] = self["webpackChunkmy_project"] || []).push([[7675],{
...
function areEqual(prevProps, nextProps) {
    var values = prevProps.values, otherProps = (0,tslib_es6/* __rest */.Tt)(prevProps, ["values"]);
    var nextValues = nextProps.values, nextOtherProps = (0,tslib_es6/* __rest */.Tt)(nextProps, ["values"]);
    return ((0,utils/* shallowEqual */.bN)(nextValues, values) &&
        (0,utils/* shallowEqual */.bN)(otherProps, nextOtherProps));
}
function FormattedMessage(props) {
    var intl = (0,useIntl/* default */.A)();
...
const StepHomepage = ({ type, title, number, content, hasLine }) => {
  ...
  return /* @__PURE__ */ react.createElement(Box/* Box */.a, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.s, null, /* @__PURE__ */ react.createElement(Box/* Box */.a, { minWidth: (0,helper_plugin_esm/* pxToRem */.a8)(30), marginRight: 5 }, /* @__PURE__ */ react.createElement(StepNumber/* default */.A, { type, number })), /* @__PURE__ */ react.createElement(Typography/* Typography */.o, { variant: "delta", as: "h3" }, formatMessage(title))), /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { alignItems: "flex-start" }, /* @__PURE__ */ react.createElement(
    Flex/* Flex */.s,
    {
      justifyContent: "center",
      minWidth: (0,helper_plugin_esm/* pxToRem */.a8)(30),
      marginBottom: 3,
      marginTop: 3,
      marginRight: 5
    },
    hasLine && /* @__PURE__ */ react.createElement(StepLine/* default */.A, { type, minHeight: type === constants/* IS_ACTIVE */.mY ? (0,helper_plugin_esm/* pxToRem */.a8)(85) : (0,helper_plugin_esm/* pxToRem */.a8)(65) })
  ), /* @__PURE__ */ react.createElement(Box/* Box */.a, { marginTop: 2 }, type === constants/* IS_ACTIVE */.mY && content)));
};
StepHomepage.defaultProps = {
  content: void 0,
  number: void 0,
  type: constants/* IS_NOT_DONE */.aE,
  hasLine: true
};
StepHomepage.propTypes = {
  ...
  type: prop_types_default().oneOf([constants/* IS_ACTIVE */.mY, constants/* IS_DONE */.sO, constants/* IS_NOT_DONE */.aE]),
...
const getType = (activeSectionIndex, index) => {
  if (activeSectionIndex === -1) {
    return constants/* IS_DONE */.sO;
  }
  if (index < activeSectionIndex) {
    return constants/* IS_DONE */.sO;
  }
  if (index > activeSectionIndex) {
    return constants/* IS_NOT_DONE */.aE;
  }
  return constants/* IS_ACTIVE */.mY;
};
const StepperHomepage = ({ sections, currentSectionKey }) => {
  ...
  return /* @__PURE__ */ react.createElement(Box/* Box */.a, null, sections.map((section, index) => /* @__PURE__ */ react.createElement(
    Step,
    {
      key: section.key,
      title: section.title,
...
const GuidedTourHomepage = () => {
  const { guidedTourState, setSkipped } = (0,helper_plugin_esm/* useGuidedTour */.Cx)();
  const { formatMessage } = (0,useIntl/* default */.A)();
  const { trackUsage } = (0,helper_plugin_esm/* useTracking */.z1)();
  const sections = Object.entries(layout/* default */.A).map(([key, val]) => ({
    key,
    ...
    content: /* @__PURE__ */ react.createElement(
      helper_plugin_esm/* LinkButton */.z9,
      {
        ...
        endIcon: /* @__PURE__ */ react.createElement(ArrowRight/* default */.A, null)
      },
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { direction: "column", alignItems: "stretch", gap: 6 }, /* @__PURE__ */ react.createElement(Typography/* Typography */.o, { variant: "beta", as: "h2" }, formatMessage({
      id: "app.components.GuidedTour.title",
      defaultMessage: "3 steps to get started"
    })), /* @__PURE__ */ react.createElement(Stepper, { sections, currentSectionKey: activeSection })),
    /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { justifyContent: "flex-end" }, /* @__PURE__ */ react.createElement(Button/* Button */.$, { variant: "tertiary", onClick: handleSkip }, formatMessage({ id: "app.components.GuidedTour.skip", defaultMessage: "Skip the tour" })))
  );
};
...
const CloudBox = () => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(
      ...
      /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { gap: 1, direction: "column", alignItems: "start" }, /* @__PURE__ */ react.createElement(Flex/* Flex */.s, null, /* @__PURE__ */ react.createElement(Typography/* Typography */.o, { fontWeight: "semiBold", variant: "pi" }, formatMessage({
        id: "app.components.BlockLink.cloud",
        defaultMessage: "Strapi Cloud"
      }))), /* @__PURE__ */ react.createElement(Typography/* Typography */.o, { textColor: "neutral600" }, formatMessage({
      ...
      })), /* @__PURE__ */ react.createElement(Box/* Box */.a, { src: strapi_cloud_flags_namespaceObject, position: "absolute", top: 0, right: 0, as: "img" }))
    )
  );
};
...
const ContentBlocks_BlockLink = styled_components_browser_esm/* default */.Ay.a`
  text-decoration: none;
`;
const ContentBlocks = () => {
  const { formatMessage } = (0,useIntl/* default */.A)();
  ...
  return /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { direction: "column", alignItems: "stretch", gap: 5 }, /* @__PURE__ */ react.createElement(HomePage_CloudBox, null), /* @__PURE__ */ react.createElement(
...
var Link = __webpack_require__(96808);
...
const HomeHeader = ({ hasCreatedContentType, onCreateCT }) => {
  const { formatMessage } = (0,useIntl/* default */.A)();
  return /* @__PURE__ */ react.createElement("div", null, /* @__PURE__ */ react.createElement(Box/* Box */.a, { paddingLeft: 6, paddingBottom: 10 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { direction: "column", alignItems: "flex-start", gap: 5 }, /* @__PURE__ */ react.createElement(Typography/* Typography */.o, { as: "h1", variant: "alpha" }, hasCreatedContentType ? formatMessage({
  ...
  })), hasCreatedContentType ? /* @__PURE__ */ react.createElement(Link/* Link */.N, { isExternal: true, href: "https://strapi.io/blog" }, formatMessage({
    id: "app.components.HomePage.button.blog",
    defaultMessage: "See more on the blog"
  })) : /* @__PURE__ */ react.createElement(Button/* Button */.$, { size: "L", onClick: onCreateCT, endIcon: /* @__PURE__ */ react.createElement(ArrowRight/* default */.A, null) }, formatMessage({
...
var Github = __webpack_require__(63545);
...
const socialLinks = [
  {
    ...
    icon: /* @__PURE__ */ react.createElement(Github/* default */.A, { fill: "#7289DA" }),
    alt: "github"
  },
  {
...
const SocialLinks = () => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Box/* Box */.a, { paddingBottom: 7 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { direction: "column", alignItems: "stretch", gap: 5 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.s, { direction: "column", alignItems: "stretch", gap: 3 }, /* @__PURE__ */ react.createElement(Typography/* Typography */.o, { variant: "delta", as: "h2", id: "join-the-community" }, formatMessage({
    ...
    }))), /* @__PURE__ */ react.createElement(Link/* Link */.N, { href: "https://feedback.strapi.io/", isExternal: true, endIcon: /* @__PURE__ */ react.createElement(ExternalLink/* default */.A, null) }, formatMessage({
    ...
    /* @__PURE__ */ react.createElement(GridGap, null, socialLinksExtended.map(({ icon, link, name }) => {
      return /* @__PURE__ */ react.createElement(GridItem/* GridItem */.E, { col: 6, s: 12, key: name.id }, /* @__PURE__ */ react.createElement(LinkCustom, { size: "L", startIcon: icon, variant: "tertiary", href: link, isExternal: true }, formatMessage(name)));
    }))
  );
};
...
`;
const HomePageCE = () => {
  const { collectionTypes, singleTypes, isLoading: isLoadingForModels } = (0,useContentTypes/* useContentTypes */.m)();
  const { guidedTourState, isGuidedTourVisible, isSkipped } = (0,helper_plugin_esm/* useGuidedTour */.Cx)();
  ...
  return /* @__PURE__ */ react.createElement(Layout/* Layout */.P, null, /* @__PURE__ */ react.createElement(message, { id: "HomePage.helmet.title", defaultMessage: "Homepage" }, (title) => /* @__PURE__ */ react.createElement(Helmet/* Helmet */.m, { title: title[0] })), /* @__PURE__ */ react.createElement(Main/* Main */.g, null, /* @__PURE__ */ react.createElement(LogoContainer, null, /* @__PURE__ */ react.createElement("img", { alt: "", "aria-hidden": true, src: corner_ornament_namespaceObject })), /* @__PURE__ */ react.createElement(Box/* Box */.a, { padding: 10 }, /* @__PURE__ */ react.createElement(Grid/* Grid */.x, null, /* @__PURE__ */ react.createElement(GridItem/* GridItem */.E, { col: 8, s: 12 }, /* @__PURE__ */ react.createElement(
    HomePage_HomeHeader,
    {
      onCreateCT: handleClick,
      hasCreatedContentType: hasAlreadyCreatedContentTypes
    }
  ))), /* @__PURE__ */ react.createElement(Grid/* Grid */.x, { gap: 6 }, /* @__PURE__ */ react.createElement(GridItem/* GridItem */.E, { col: 8, s: 12 }, showGuidedTour ? /* @__PURE__ */ react.createElement(Homepage, null) : /* @__PURE__ */ react.createElement(HomePage_ContentBlocks, null)), /* @__PURE__ */ react.createElement(GridItem/* GridItem */.E, { col: 4, s: 12 }, /* @__PURE__ */ react.createElement(HomePage_SocialLinks, null))))));
};
function HomePageSwitch() {
  const HomePage = (0,useEnterprise/* useEnterprise */.h)(
    HomePageCE,
    // eslint-disable-next-line import/no-cycle
    async () => (await __webpack_require__.e(/* import() */ 2835).then(__webpack_require__.bind(__webpack_require__, 32835))).HomePageEE
  );
  if (!HomePage) {
    return null;
  }
