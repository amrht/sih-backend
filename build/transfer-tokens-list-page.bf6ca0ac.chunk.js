"use strict";
(self["webpackChunkmy_project"] = self["webpackChunkmy_project"] || []).push([[314],{
...
const TransferTokenListView = () => {
  ...
  const {
    ...
    async () => {
      ...
      trackUsage("didAccessTokenList", { number: data.length, tokenType: constants/* TRANSFER_TOKEN_TYPE */.j });
      return data;
    },
    {
      enabled: canRead,
  ...
  return /* @__PURE__ */ react.createElement(Main/* Main */.g, { "aria-busy": isLoading }, /* @__PURE__ */ react.createElement(helper_plugin_esm/* SettingsPageTitle */.x7, { name: "Transfer Tokens" }), /* @__PURE__ */ react.createElement(
...
const ProtectedTransferTokenListView = () => {
  const permissions = (0,es/* useSelector */.d4)(selectors/* selectAdminPermissions */.G);
  return /* @__PURE__ */ react.createElement(helper_plugin_esm/* CheckPagePermissions */.kz, { permissions: permissions.settings["transfer-tokens"].main }, /* @__PURE__ */ react.createElement(ListView, null));
};
